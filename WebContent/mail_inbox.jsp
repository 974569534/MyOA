...
<div id="container">
	...
	<div class="container">
			<div class="component">
				<div><button onclick="del()">删除</button>&nbsp;&nbsp;<button>转发</button>&nbsp;&nbsp;<button>举报</button>&nbsp;&nbsp;<button>全部标为已读</button>&nbsp;&nbsp;<button>标记为已读邮件</button>&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="isRead()">查看所有已读邮件</button>&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="isNoRead()">查看所有未读邮件</button>&nbsp;&nbsp;</div>
			...
			success:function(data){
				...
				$(".email").remove();
 				$(data).each(function(){
					...
					$("#tab tbody").append((this.IfDel==0&&this.IfRead==0&&this.IfPublish==1?"<tr class='email'><td><input type='checkbox' value='"+this.EamilId+"' class='check'/></td><td>"+(this.IfRead==0?"<a href='selectDetails.do?eamilId="+this.EamilId+"'><img src='images/rmail.png' /></a>":"<a href='selectDetails.do?eamilId="+this.EamilId+"'><img src='images/rmail1.png' /></a>")+"</td><td>"+this.Name+"</td><td>"+this.Title+"</td><td>"+oTime+"</td></tr>":""));
			...
			success:function(data){
				function getzf(num){
 				...
 				$(data).each(function(){
					...
					$("#tab tbody").append((this.IfDel==0&&this.IfPublish==1?"<tr class='email'><td><input type='checkbox' value='"+this.EamilId+"' class='check'/></td><td>"+(this.IfRead==0?"<a href='selectDetails.do?eamilId="+this.EamilId+"'><img src='images/rmail.png' /></a>":"<a href='selectDetails.do?eamilId="+this.EamilId+"'><img src='images/rmail1.png' /></a>")+"</td><td>"+this.Name+"</td><td>"+this.Title+"</td><td>"+oTime+"</td></tr>":""));
